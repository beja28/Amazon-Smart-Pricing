...
# ==================== TAB 1: RESUMEN ====================
    ...
    # ==================== TAB 2: ANÁLISIS DE MERCADO ====================
        ...
        st.markdown('<div class="section-label" style="color: #ffffff; font-size: 0.85rem; margin-top: 2.5rem;">¿Qué Hace la Diferencia?</div>', unsafe_allow_html=True)
        st.markdown('<p style="font-size:0.8rem;color:#8b9099;margin-bottom:1.5rem;">Descubre qué características (Buy Box, Cupones, Premium...) impactan más en el precio y ventas de tu mercado.</p>', unsafe_allow_html=True)
        ...
        # ========== SECCIÓN 4: ANÁLISIS DE BRECHA COMPETITIVA ==========
        st.markdown('<div class="section-label" style="color: #ffffff; font-size: 0.85rem; margin-top: 3.5rem;">Análisis de Brecha Competitiva (Gap Analysis)</div>', unsafe_allow_html=True)
        st.markdown('<p style="font-size:0.8rem;color:#8b9099;margin-bottom:1.5rem;">Compara el perfil de tu producto frente a tus competidores directos y descubre la distancia exacta hacia el liderazgo en tu nicho.</p>', unsafe_allow_html=True)
